            ...
            <div class="form-row">
                <div class="input-group">
                    ...
                    <div class="form-field">
                        ...
                        <input class="info1" type="text" name="txtgioitinh" value="<?php echo $gioitinh; ?>" disabled>
                    </div>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="input-group">
                    ...
                    <div class="form-field">
                        ...
                        <input class="info1" type="email" name="txtkhoahoc" value="<?php echo $khoahoc; ?>" disabled>
                    </div>
                </div>
            </div>
            </form>
