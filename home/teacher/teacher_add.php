...
<body>
   ...
   <div class="col" style="margin-top: 10px;">
      <div class="input-group">
         ...
         <div class="form-field">
            <label>Điểm chuyên cần</label>
            <input class="info1" type="text" name="txtdiemcc" value="<?php echo $cc; ?>" placeholder="Điểm chuyên cần">
         </div>
      </div>
   </div>
   <div class="col" style="margin-top: 10px;">
      <div class="input-group">
         ...
         <div class="form-field">
            <label>Điểm giữa kỳ</label>
            <input class="info1" type="text" name="txtdiemgk" value="<?php echo $gk; ?>" placeholder="Điểm giữa kỳ">
         </div>
      </div>
   </div>
   <div class="col" style="margin-top: 10px;">
      <div class="input-group">
         ...
         <div class="form-field">
            <label>Điểm cuối kỳ</label>
            <input class="info1" type="text" name="txtdiemck" value="<?php echo $ck; ?>" placeholder="Điểm cuối kỳ">
         </div>
      </div>
   </div>
   <button type="submit" class="btn btn-success" name="btnLuu"
